package sp.models {
  ...
  object APIModel {
    ...
    case class SPItemInfo(id: ID, name: String, typ: String)
    case object GetAllItemInfo extends Request
    case class GetItemInfo(itemIDs: List[ID]) extends Request
    case class SPItemInfoList(info: List[SPItemInfo]) extends Response

    case class GetItemAttributes(itemIDs: List[ID]) extends Request
    case class SPAttributesList(itemIDs: List[SPAttributes]) extends Response
    ...
    object Formats {
      ...
      implicit val fGetAllItemInfo: JSFormat[GetAllItemInfo.type] = deriveCaseObject[GetAllItemInfo.type]
      implicit val fGetItemInfo: JSFormat[GetItemInfo] = Json.format[GetItemInfo]
      implicit val fSPItemInfo: JSFormat[SPItemInfo] = Json.format[SPItemInfo]
      implicit val fSPItemInfoList: JSFormat[SPItemInfoList] = Json.format[SPItemInfoList]
      implicit val fGetItemAttributes: JSFormat[GetItemAttributes] = Json.format[GetItemAttributes]
      implicit val fSPAttributesMap: JSFormat[SPAttributesList] = Json.format[SPAttributesList]
